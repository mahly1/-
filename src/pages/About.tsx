    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20 space-y-4">
          ...
          <h1 className="text-5xl lg:text-7xl font-black font-display text-gray-900 italic tracking-tighter">عن الحملة</h1>
          <p className="text-xl text-gray-500 max-w-3xl mx-auto font-medium">تعرّف على قصتنا وليه قررنا إننا نكون "وضع طيران".</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          <div className="bg-green-50 p-12 rounded-[4rem] relative">
            ...
            <div className="space-y-12">
              <div className="flex gap-6 items-start">
                ...
                <div>
                    <h3 className="text-xl font-black text-gray-900 mb-2 italic">رسالتنا</h3>
                    <p className="text-gray-600 font-bold italic">إننا نرجع الأمان للبيوت من خلال الاستماع والاهتمام، ونساعد الأهالي يكتشفوا إن التربية بتبدأ من تحت العين وتواصل القلوب.</p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                    <h3 className="text-xl font-black text-gray-900 mb-2 italic">مين بنخاطب؟</h3>
                    <p className="text-gray-600 font-bold italic">كل أب وأم، جد وجدة، وكل حد شايل مسئولية طفل ومحتاج طاقة جديدة علشان يكمل صح.</p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                    <h3 className="text-xl font-black text-gray-900 mb-2 italic">إحنا عايزين نغير إيه؟</h3>
                    <p className="text-gray-600 font-bold italic">عايزين نغير ثقافة "الإهمال غير المقصود" ونبدلها بثقافة "الحضور الكامل" ولو لعشر دقايق في اليوم.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="py-24 border-t border-gray-100">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-4xl font-black font-display text-gray-900 italic tracking-tight">رحلة وضع طيران</h2>
            <p className="text-gray-500 font-medium italic">خطوات بسيطة نحو حياة أهدى وأمتن.</p>
          </div>
          ...
          <div className="relative">
            ...
            {[
              ...
              >
                ...
                <div className="w-5/12 bg-white p-8 rounded-3xl shadow-xl shadow-green-100/50 border border-green-50 space-y-4">
                  <h3 className="text-xl font-black text-primary-green italic">{step.title}</h3>
                  <p className="text-gray-600 italic leading-relaxed">{step.text}</p>
                </div>
              </motion.div>
            ))}
          </div>
